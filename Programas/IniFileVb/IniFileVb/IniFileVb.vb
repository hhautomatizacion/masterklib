...
Public Class IniFileVb
    ...
    Public Sub Save(ByVal sFileName As String)
        ...
        For Each a As IniSection In Sections
            l.Add(a.Name)
        Next
        l.Sort()
    ...
    Public Class IniSection
        Private m_pIniFile As IniFileVb
        Private m_sSection As String
        Private m_keys As Hashtable
        Protected Friend Sub New(ByVal parent As IniFileVb, ByVal sSection As String)
            m_pIniFile = parent
            m_sSection = sSection
